...
func registerCommonAuthenticationServerProtocols() {
	...
	port, _ := strconv.Atoi(os.Getenv("PN_MHS_SECURE_SERVER_PORT"))

	secureStationURL := types.NewStationURL("")
	secureStationURL.SetURLType(constants.StationURLPRUDPS)
	secureStationURL.SetAddress(os.Getenv("PN_MHS_SECURE_SERVER_HOST"))
	...
	commonTicketGrantingProtocol.BuildName = types.NewString("branch:origin/release/ngs/3.10.x.200x build:3_10_26_2006_0")
